...
/**
 * Clase de la mascota tipo Pulpo.
 * Asigna y gestiona atributos personaolizados y comportamiento de la mascota.
 */
public class Pulpo extends Mascotas{

    /**
     * Constructor que inicializa el habitat en ACUATICO y su precio correspondiente.
     */
    public Pulpo() {
        super(Habitat.ACUATICO, 300);
    }
    ...
    public void alimentar(Alimento alimento){
        if(alimento.getTipoMascota()==TipoMascota.PULPO){
    ...
    public TipoSuministro getTipoAlimento() {
        return TipoSuministro.ALIMENTO_PULPO;
    }
}
